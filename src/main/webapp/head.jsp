	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" style="background-color:rgba(128,138,135,0.6);font-size:18px;font-family:Microsoft YaHei;">
		<div class="container" style="width:100%;">
			<div class="navbar-header" style="margin-left:3%">
				...
				<a class="navbar-brand" href="/index.jsp"><img src="/progressus/assets/images/1.jpg"height="40" width="170" ></a>
			</div>
			<div class="navbar-collapse collapse" style="float:left;">
				<ul class="nav navbar-nav pull-right">
					<li><a href="/" style="font-weight:bold;">主页</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-weight:bold;">自动化测试<b class="caret"></b></a>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" style="background-color:rgba(88,87,86,0.6);">
							<li><a href="javascript:window.open('http://192.168.10.23:9000/zentao/my/')">用例管理(TestLink)</a></li>
							<li><a href="javascript:window.open('http://192.168.10.23:9000/zentao/my/')">缺陷管理(JIRA)</a></li>
							<li><a href="javascript:window.open('http://192.168.10.23:9000/zentao/my/')">项目管理(ZenTao)</a></li>
							<li><a href="javascript:window.open('http://192.168.10.132:8089/')">持续集成(Jenkins)</a></li>
							<li><a href="javascript:window.open('http://XXX.XX.XX.XX/users/sign_in')">代码管理(GIT)</a></li>
							<li><a href="javascript:window.open('http://192.168.10.132:8089/')">代码质量(Sonar)</a></li>
						</ul>
					</li>
					<li class="dropdown">
						...
						<ul class="dropdown-menu" style="background-color:rgba(88,87,86,0.6);">
                            ...
                            <li><a href="javascript:window.open('http://XXX.XX.XX.XX:8080/tesst2/')">测试系统二3</a></li>
						</ul>
					</li>
					<!--
					<li class="dropdown">
	...
	$.ajax({
		...
		success:function (result){
	    	if(result.data[0]==null){
	    		...
	    		document.getElementById("loginmess").innerHTML = result.data[2]+"("+result.data[1]+")";
